...
export function AddFacultyDialog({ open, onOpenChange, onSuccess }: AddFacultyDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      // Insert faculty (POST /users/faculty)
      const facultyData = await api.post("/users/faculty", {
        data: {
          name: formData.name,
      ...
      // Insert faculty assignment (POST /ratings/assignments)
      await api.post("/ratings/assignments", {
        data: {
