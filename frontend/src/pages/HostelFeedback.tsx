...
export default function HostelFeedback() {
  ...
  const checkAuthAndLoadData = async () => {
    try {
      // Check auth via local storage or api profile
      ...
      // API returns null or the rating object
      const existing = await api.get("/ratings/hostel");
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Backend handles upsert logic in createHostelRating
      await api.post("/ratings/hostel", {
        data: {
          ...ratings,
